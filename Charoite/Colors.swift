...
extension Color {
    public static let mint = Color(UIColor(red: 222/255, green: 255/255, blue: 242/255, alpha: 1))
    public static let pinky = Color(UIColor(red: 214/255, green: 143/255, blue: 214/255, alpha: 1))
    public static let yellowy = Color(UIColor(red: 233/255, green: 206/255, blue: 44/255, alpha: 1))
